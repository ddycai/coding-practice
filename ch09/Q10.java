/*
 * You have a stack of n boxes, with widths w, heights l and depths d. The boxes
 ...
 * Implement a method to build the tallest stack possible, where the heigh t of a
